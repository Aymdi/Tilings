...
//color_cstring
    ...
    if (strcmp(color_cstring(color_from_name("noir")),"\e[0;30m noir \e[0m" ) == 0)
        printf("color_cstring: PASSED (1/5)\n");
    else
        printf("color_cstring: FAILED in line %d\n",__LINE__);
    if (strcmp(color_cstring(color_from_name("rouge")),"\e[0;31m rouge \e[0m" ) == 0)
        printf("color_cstring: PASSED (2/5)\n");
    else
        printf("color_cstring: FAILED in line %d\n",__LINE__);
    if (strcmp(color_cstring(color_from_name("vert")),"\e[0;32m vert \e[0m" ) == 0)
        printf("color_cstring: PASSED (3/5)\n");
    else
        printf("color_cstring: FAILED in line %d\n",__LINE__);
    if (strcmp(color_cstring(color_from_name("jaune")),"\e[0;33m jaune \e[0m" ) == 0)
        printf("color_cstring: PASSED (4/5)\n");
    else
        printf("color_cstring: FAILED in line %d\n",__LINE__);
    if (strcmp(color_cstring(color_from_name("bleu")),"\e[0;34m bleu \e[0m" ) == 0)
